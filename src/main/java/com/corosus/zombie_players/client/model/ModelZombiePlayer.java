package com.corosus.zombie_players.client.model;
...
public class ModelZombiePlayer extends ModelBiped
{
    ...
    public ModelZombiePlayer(float modelSize, boolean smallArmsIn)
    {
