...
public class EntityAINearestAttackableTargetIfCalm<T extends EntityLivingBase> extends EntityAITarget
{
    protected final Class<T> targetClass;
    private final int targetChance;
    /** Instance of EntityAINearestAttackableTargetSorter. */
    protected final EntityAINearestAttackableTargetIfCalm.Sorter sorter;
    protected final Predicate <? super T > targetEntitySelector;
    protected T targetEntity;

    protected EntityZombiePlayer entity;
    ...
    public EntityAINearestAttackableTargetIfCalm(EntityZombiePlayer creature, Class<T> classTarget, int chance, boolean checkSight, boolean onlyNearby, @Nullable final Predicate <? super T > targetSelector, boolean invert)
    {
        ...
        this.sorter = new EntityAINearestAttackableTargetIfCalm.Sorter(creature);
        this.setMutexBits(1);
        this.targetEntitySelector = new Predicate<T>()
        {
            public boolean apply(@Nullable T p_apply_1_)
            {
                ...
                {
                    return !EntitySelectors.NOT_SPECTATING.apply(p_apply_1_) ? false : EntityAINearestAttackableTargetIfCalm.this.isSuitableTarget(p_apply_1_, false);
                }
            }
        };
    }
            ...
            this.targetEntity = (T)this.taskOwner.world.getNearestAttackablePlayer(this.taskOwner.posX, this.taskOwner.posY + (double)this.taskOwner.getEyeHeight(), this.taskOwner.posZ, this.getTargetDistance(), this.getTargetDistance(), new Function<EntityPlayer, Double>()
            {
                ...
                public Double apply(@Nullable EntityPlayer p_apply_1_)
                {
                    ...
                    if (itemstack.getItem() == Items.SKULL)
                    {
                        ...
                        boolean flag = EntityAINearestAttackableTargetIfCalm.this.taskOwner instanceof EntitySkeleton && i == 0;
                        boolean flag1 = EntityAINearestAttackableTargetIfCalm.this.taskOwner instanceof EntityZombie && i == 2;
                        boolean flag2 = EntityAINearestAttackableTargetIfCalm.this.taskOwner instanceof EntityCreeper && i == 4;
