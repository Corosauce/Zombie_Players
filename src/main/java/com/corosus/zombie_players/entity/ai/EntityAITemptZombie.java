...
public class EntityAITemptZombie extends EntityAIBase
{
    ...
    public EntityAITemptZombie(EntityCreature temptedEntityIn, double speedIn, boolean scaredByPlayerMovementIn/*, Set<Item> temptItemIn*/)
    {
    ...
    {
        if (temptedEntity.getAttackTarget() != null) return false;
        ...
        {
            this.temptingPlayer = this.temptedEntity.world.getClosestPlayerToEntity(this.temptedEntity, 18.0D);
